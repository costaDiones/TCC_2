...
class InboxesControllerTest < ActionController::TestCase
  ...
  test "should create inbox" do
    assert_difference('Inbox.count') do
      post :create, inbox: { Users_id: @inbox.Users_id, descripition: @inbox.descripition, title: @inbox.title }
    end
  ...
  test "should update inbox" do
    patch :update, id: @inbox, inbox: { Users_id: @inbox.Users_id, descripition: @inbox.descripition, title: @inbox.title }
    assert_redirected_to inbox_path(assigns(:inbox))
  end
