...
class ConsumptionsControllerTest < ActionController::TestCase
  ...
  test "should create consumption" do
    assert_difference('Consumption.count') do
      post :create, consumption: { user_id: @consumption.user_id, value_consumption: @consumption.value_consumption }
    end
  ...
  test "should update consumption" do
    patch :update, id: @consumption, consumption: { user_id: @consumption.user_id, value_consumption: @consumption.value_consumption }
    assert_redirected_to consumption_path(assigns(:consumption))
  end
